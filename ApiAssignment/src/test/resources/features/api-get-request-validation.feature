Feature: TM Sandbox API Response Validation
  ...
  As a user, I want to validate specific fields in the response generated by the TM Sandbox API after processing an HTTP GET request based on the following Acceptance Criteria:
  
  Acceptance Criteria:
  	1. The field "Name" should be "Carbon credits".
    2. The field "CanRelist" should be true.
    3. The element "Promotions" with "Name" as "Gallery" should have a "Description" that contains the text "Good position in category".
